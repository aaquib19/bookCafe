...

{
    class Details {
        constructor() {
            ...
            <button class="details__addtocart" formaction="{% url 'ajax_check' %}">Book Issue</button>
      ...
      /*     this.DOM.cart.addEventListener('click', () => $(document).ready(function(){

      $.ajax({
        url: 'cat1books/ajax/check/',
        data: {
          'username': username
        },
        cache: false,
